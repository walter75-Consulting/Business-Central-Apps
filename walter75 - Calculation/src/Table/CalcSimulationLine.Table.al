table 90806 "SEW Calc Simulation Line"
{
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Simulation No.", "Scenario Code", "Lot Size", "Total Cost", "Unit Cost", "Suggested Sales Price", "Margin %", "Is Recommended")
        {
        }
        fieldgroup(Brick; "Simulation No.", "Scenario Code", "Lot Size", "Total Cost", "Unit Cost", "Suggested Sales Price", "Margin %", "Is Recommended")
        {
        }
    }
