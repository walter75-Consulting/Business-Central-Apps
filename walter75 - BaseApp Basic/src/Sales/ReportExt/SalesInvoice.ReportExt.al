reportextension 80015 "SEW Sales Invoice" extends "Standard Sales - Invoice"
{
    dataset
    {
        add(Header)
...
#pragma warning restore LC0068
    ...
    rendering
    {
        layout("SEW Sales Invoice 01")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesInvoice01.rdlc';
            Caption = 'Sales Invoice Design 01 (RDLC)';
            Summary = 'Sales Invoice (RDLC)';
        }
        layout("SEW Sales Invoice 01 eMail")
        {
            Type = Word;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesInvoice01 eMail.docx';
            Caption = 'Sales Invoice Design 01 eMail (Word)';
            Summary = 'Sales Invoice eMail (Word)';
        }
        layout("SEW Sales Invoice 02")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesInvoice02.rdlc';
            Caption = 'Sales Invoice Design 02 (RDLC)';
            Summary = 'Sales Invoice (RDLC)';
        }
        layout("SEW Sales Invoice 03")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesInvoice03.rdlc';
            Caption = 'Sales Invoice Design 03 (RDLC)';
            Summary = 'Sales Invoice (RDLC)';
        }
    }
