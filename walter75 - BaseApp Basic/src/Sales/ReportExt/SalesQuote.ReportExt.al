reportextension 80017 "SEW Sales - Quote" extends "Standard Sales - Quote"
{
    dataset
    {
        add(Header)
...
#pragma warning restore LC0068
                ...
                SEW_DocTextSalesHeader := SEWReportFunctions.GetDocumentTextSales(Header."Sell-to Contact No.", "Language Code", "Sales Document Type"::Quote, "SEW Document Text Position"::Header, false);
                SEW_DocTextSalesFooter := SEWReportFunctions.GetDocumentTextSales(Header."Sell-to Contact No.", "Language Code", "Sales Document Type"::Quote, "SEW Document Text Position"::Footer, false);
                SEW_DocTextSalesHeaderMail := SEWReportFunctions.GetDocumentTextSales(Header."Sell-to Contact No.", "Language Code", "Sales Document Type"::Quote, "SEW Document Text Position"::Header, true);
                SEW_DocTextSalesFooterMail := SEWReportFunctions.GetDocumentTextSales(Header."Sell-to Contact No.", "Language Code", "Sales Document Type"::Quote, "SEW Document Text Position"::Footer, true);
...
#pragma warning restore LC0068
    ...
    rendering
    {
        layout("SEW Sales Quote01")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesQuote01.rdlc';
            Caption = 'Sales Quote 01 (RDLC)';
            Summary = 'Sales Quote (RDLC)';
        }
        layout("SEW Sales Invoice 01 eMail")
        {
            Type = Word;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesQuote01 eMail.docx';
            Caption = 'Sales Quote Design 01 eMail (Word)';
            Summary = 'Sales Quote eMail (Word)';
        }
        layout("SEW Sales Quote02")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesQuote02.rdlc';
            Caption = 'Sales Quote 02 (RDLC)';
            Summary = 'Sales Quote (RDLC)';
        }
