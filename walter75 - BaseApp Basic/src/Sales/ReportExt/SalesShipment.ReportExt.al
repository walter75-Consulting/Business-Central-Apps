reportextension 80018 "SEW Sales - Shipment" extends "Standard Sales - Shipment"
{
    dataset
    {
        add(Header)
...
#pragma warning restore LC0068
                ...
                // SEW_DocTextSalesHeader := SEWReportFunctions.GetDocumentTextSales(Header."Sell-to Contact No.", "Language Code", "Sales Document Type"::Invoice, "SEW Document Text Position"::Header, false);
                // SEW_DocTextSalesFooter := SEWReportFunctions.GetDocumentTextSales(Header."Sell-to Contact No.", "Language Code", "Sales Document Type"::Invoice, "SEW Document Text Position"::Footer, false);
                // SEW_DocTextSalesHeaderMail := SEWReportFunctions.GetDocumentTextSales(Header."Sell-to Contact No.", "Language Code", "Sales Document Type"::Invoice, "SEW Document Text Position"::Header, true);
                // SEW_DocTextSalesFooterMail := SEWReportFunctions.GetDocumentTextSales(Header."Sell-to Contact No.", "Language Code", "Sales Document Type"::Invoice, "SEW Document Text Position"::Footer, true);
...
#pragma warning disable LC0068
                    ...
                    if DimensionSetEntry.Get("Dimension Set ID", 'AUFSTELLER') then
                        SEWDimHV := DimensionSetEntry."Dimension Value Code";
                end;
            end;
        ...
        add(Line)
        {
            ...
            column(SEW_ShelfNo; "SEW Shelf No.") { }
        ...
        {
            column(SEW_Expiration_Date; TempTrackingSpecBuffer."Expiration Date") { }
            column(SEW_Expiration_DateLbl; TempTrackingSpecBuffer.FieldCaption("Expiration Date")) { }
        }
    }

    rendering
    {
        layout("LSH Sales Shipment01")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesShipment01.rdlc';
            Caption = 'Sales Shipment Design 01 (RDLC)';
            Summary = 'Sales Shipment (RDLC)';
        }
        layout("SEW Sales Shipment01 01 eMail")
        {
            Type = Word;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesShipment01 eMail.docx';
            Caption = 'Sales Shipment01 Design 01 eMail (Word)';
            Summary = 'Sales Shipment01 eMail (Word)';
        }
        layout("LSH Sales Shipment02")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesShipment02.rdlc';
            Caption = 'Sales Shipment Design 02 (RDLC)';
            Summary = 'Sales Shipment (RDLC)';
        }
        layout("LSH Sales Shipment03")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesShipment03.rdlc';
            Caption = 'Sales Shipment Design 03 (RDLC)';
            Summary = 'Sales Shipment (RDLC)';
        }
        layout("LSH Sales Shipment04")
        {
            Type = RDLC;
            LayoutFile = './src/Sales/ReportExt/Layout/SalesShipment04.rdlc';
            Caption = 'Sales Shipment Design 04 (RDLC)';
            Summary = 'Sales Shipment (RDLC)';
        }
    }
